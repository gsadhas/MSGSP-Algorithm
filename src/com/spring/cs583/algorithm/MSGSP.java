...
class MSGSP {
	...
	public static ArrayList<Item> retrieveMISval(String parameterFilePath){
		...
		catch (Exception ex)
		{
			...
			System.out.println("\nData File could not be read!!! In MIS Retrival");
		}	
...
//			patternObj = null;}
//		
		if ((curReadLine = nextSeqReader.readLine()) != null && (curReadLine = nextSeqReader.readLine()).length() >=4) {
			
			//System.out.println("Read : " +curReadLine);
		...
		//System.out.println("Before count " + headcount);
		headcount +=1;
		//System.out.println(" After count " + headcount);
	...
	{
		System.out.println("\nData File could not be read!!! in fetchNextSeq");
	}	
...
//   		
//   		
//   		for(ItemSet is : patternObj.getItemsets()){
//   			
//   			System.out.print("{");
//   			
//   			
//   			for(int j=0; j < is.getItems().size(); j++){
//   				
//   				if(j == is.getItems().size() - 1){
//   					System.out.print(is.getItems().get(j));
//   					
//   				}
//   				else{
//   					System.out.print(is.getItems().get(j) + ",");
...
//   		}	
//   		
//   		//System.out.print("> Count : " + candi.getCount() + " \n");
//   		
//   		
//       }
////	 // **********//
